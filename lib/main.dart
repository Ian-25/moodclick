  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/moodupdate': (context) => const MoodSelectorScreen(), // Mood Update Screen
        ...
        '/counselling': (context) =>
          CounsellorsProfilePage(), // Counselling Screen
        '/SpeAdvice': (context) => const AdvicePage(), // advice screen
